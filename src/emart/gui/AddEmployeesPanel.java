 ...
 * @author HP
 */
public class AddEmployeesPanel extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Add Employees Panel", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 24), new java.awt.Color(255, 255, 255))); // NOI18N
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        try
        {
            ...
            if(!result)
            {
                JOptionPane.showMessageDialog(null,"Record added successsfully","Success!",JOptionPane.INFORMATION_MESSAGE);
                 return;
            }
            JOptionPane.showMessageDialog(null,"Please input all fields","Error!",JOptionPane.ERROR_MESSAGE);
            clearText();
        ...
        {
            JOptionPane.showMessageDialog(null,"please input number for salary","Error!",JOptionPane.ERROR_MESSAGE);
            ex.printStackTrace();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddEmployeesPanel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddEmployeesPanel().setVisible(true);
            }
        });
    }
